...
export class AdminPanelComponent implements OnInit {
  ...
  openDialogDelete(user) {
    ...
    const dialogRef = this.dialog.open(DialogDataDelete, { data: { id: user.id, email: user.email }});
  ...
  openDialogEdit(user){
    let index = ELEMENT_DATA.indexOf(user)
    const dialogRef = this.dialog.open(DialogDataEdit, { data: 
      { 
      id: user.id, 
      email: user.email, 
...
export class DialogDataEdit {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogDataEdit>,
...
export class DialogDataAdd implements OnInit{
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogDataAdd>,
    @Inject(MAT_DIALOG_DATA) public data: DialogData, private toastrService: ToastrService,
...
export class DialogDataDelete {
  ...
  constructor(
    public dialogRef: MatDialogRef<DialogDataDelete>,
    @Inject(MAT_DIALOG_DATA) public data: DialogData) { }
}